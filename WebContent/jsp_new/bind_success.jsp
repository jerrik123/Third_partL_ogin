...
<div id="head_mango">
	<jsp:include page="/headmango/header_member_2015.jsp" flush="true" />
</div>
...
<!--=S footer 到时候用最新的替换-->
<div class="footer w970" style="display:none;">
<iframe scrolling="no" frameborder="no" width="100%" id="footer2010" marginheight="0" 
marginwidth="0" border="0" src="http://www.mangocity.com/include/foot.htm" name="framename"></iframe>
</div>
<!--=E footer -->
