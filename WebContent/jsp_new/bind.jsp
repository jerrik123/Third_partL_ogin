...
<div class="w968">
    ...
    <div class="statement">
        <div class="welcomeinfo">欢迎<em><span id="nickValue"></span></em>来到芒果网<br /><span>来自QQ</span></div>
    ...
    <div class="bindform">
        ...
        <div id="bindpanel">
            <div class="bindpanel" id="bindArea">
                <p class="bindNote">您正在使用芒果网的合作方--QQ的账号登录“芒果网会员”，为方便您日后登录，您可以将QQ账号与芒果网会员进行绑定。绑定后，您可以用QQ账号直接登录芒果网会员：</p>
                <div class="formWrap">
                <form action="<%=request.getContextPath()%>/tencent/register.action" method="post" id="bindForm">
            ...
            <div class="bindpanel" style="height:281px;" id="registArea">
                <p class="bindNote">您正在使用芒果网的合作方--QQ的账号登录“芒果会员”，为方便您日后登录，您可以注册成为芒果网会员，享受更多的会员服务：</p>
                <div class="formWrap">
                <form action="<%=request.getContextPath()%>/tencent/register.action" method="post" id="registForm">
                    <ul>
    ...
    <div class="passto"><a href="<%=request.getContextPath()%>/tencent/register.action?registerBean.registermode=3&registerBean.registertype=1&nick=${nick}">直接进入芒果网&gt;&gt;</a></div>
</div>
